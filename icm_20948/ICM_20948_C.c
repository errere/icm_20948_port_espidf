...
/**
 * 
 * @brief Transact directly with an I2C device, one byte at a time,Used to configure a device before it is setup into a normal 0-3 peripheral slot
 * 
 * @note use peripheral slot 4 to allow single byte r/w
*/
